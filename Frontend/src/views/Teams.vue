...
<script setup>
    ...
    const deleteTeam = async (teamId) => {
        try {
            const res = await axios.delete(`https://sports-scheduling-application.onrender.com/api/teams/${teamId}`);
    ...
    onMounted( async () => {
        ...
        const leaguesData = await axios.get('https://sports-scheduling-application.onrender.com/api/leagues');
