...
const saveEdit = async (originalLeague) => {
    ...
    try {
        ...
        `https://sports-scheduling-application.onrender.com/api/leagues/${originalLeague._id}`,
        updatedLeague
        )
...
const createLeague = async () => {
    ...
    try {
        ...
        const res = await axios.post('https://sports-scheduling-application.onrender.com/api/leagues', newEntry)
